...
export class UrlsService {
  baseUrl: string = `http://${location.hostname}:5050/api`;
  ...
  getUrlTopicNonAnsweredList(count: number) {
    return `${this.baseUrl}/topics/nonanswered/${count}/`
  }
  ...
  getUrlTagMyList() {
    return `${this.baseUrl}/tags/my/`;
  }
  getUrlTagMyPrivateList() {
    return `${this.baseUrl}/tags/my/private/`;
  }
  getUrlTagCreate() {
    return `${this.baseUrl}/tags/`;
  }
